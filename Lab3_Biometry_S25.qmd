...
::: callout-note
The log likelihood as lambda increases past \~60 decreases at a faster rate in the full data set than in the partial data set. The MLE for the partial data set is larger than the MLE for the full data set.
